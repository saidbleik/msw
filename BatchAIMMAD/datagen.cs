...
namespace datagentest
{
    class Program
    {
        ...
        private const string EhConnectionString = "Endpoint=sb://myeventhub112233.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=mykey112233;EntityPath=datagen";
